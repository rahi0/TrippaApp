...
import 'package:paytrippa_app/Screens/RegistrationPage/registrationPage2.dart';
                               ...
                               child: Column(
                                 children: <Widget>[
                                   Container(
                                     ...
                                     child: Text(
                                       registerClicked == false ? "Welcome" : "OTP Verification",
                                   ...
                                   Container(
                                     alignment: Alignment.center,
                                     child: Text(
                                       registerClicked == false ? "After registering, start earning PayTrippa points" : "Enter the OTP you received to",
                                        textAlign: TextAlign.center,
                                        style: TextStyle(
                                   ...
                                   registerClicked == false ? Container(): Container(
                                     alignment: Alignment.center,
                                     child: Text(
...
/////////////////////////////////////////Number And Pin start //////////////////////////////////
                           ...
                           registerClicked == false ?  Container(
                               //color: Colors.yellow,
...
////////////////////////////////////////Number And Pin end///////////////////////////////////
                            ...
                            registerClicked == false ? Container(
                             ...
                             Hero(
                               ...
                               child: Container(
                                ...
                                height: 45,
                                child: FlatButton(
                                  onPressed:  registerClicked == false ?_registerButton : _continueButton,

                                  child: Container(
                                    child: Text(
                                          registerClicked == false ? "Register" : "Continue",
                                          textAlign: TextAlign.center,
                                          style: TextStyle(
  ...
  void _continueButton() async{
   ...
   Navigator.push( context, FadeRoute(page: RegistrationPage2()));
  }
}